...
enum rcc_mode {
    rcc1=0,
    rcc2,
    rcc2_with_div400 // unused
};


struct clock_config {
    enum rcc_mode mode; // choose from enum
    uint32_t crystal;  // SYSCTL_RCC_XTAL_4MHZ or SYSCTL_RCC_XTAL_4_09MHZ
    uint32_t osc_source; // SYSCTL_RCC2_OSCSRC2_MO  or SYSCTL_RCC2_OSCSRC2_IO  or SYSCTL_RCC2_OSCSRC2_IO4
    uint32_t frequency; // use BusXX defines
};
...
typedef struct clock_config clock_config_T;
